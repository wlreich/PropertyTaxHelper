-- Preserve the existing typeahead ordering and incremental token matching while
-- allowing normalized numbered-street queries such as "west 36" and "w 36th".
  ...
  with candidates as (
    ...
    where (((p_show_all or not d.is_parkland) and not d.is_vacant_land)
      ...
      and (
        ...
        or (
          (house_part is null or d.search_text like house_part || ' %')
          and not exists (
            select 1
