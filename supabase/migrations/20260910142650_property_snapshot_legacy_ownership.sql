-- Layout 8.0.0.30 has no ownership_pct field. Its explicit partial-owner flag,
-- singleton property row and absent shared group remain mandatory. Later versions fail closed.
