-- PAR-66: bind current neighborhood valuation to the exact appraisal source
-- published by the active release. Historical protest analysis remains limited
-- to preliminary/certified pairs, while the current cohort may be supplemental.
