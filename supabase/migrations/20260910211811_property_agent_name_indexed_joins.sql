-- JSON privacy predicates underestimate rows; retain parameterized index lookups.
-- EXPLAIN found a repeated sequential eligibility scan despite its unique index.
