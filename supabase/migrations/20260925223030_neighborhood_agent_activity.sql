-- PAR-61: extend the active-release neighborhood contract with one latest,
-- nonblank agent assignment per visible property and tax year. The function
-- remains security invoker so property visibility and the agent-name RLS policy
-- continue to exclude candidate anchors and protected records.
