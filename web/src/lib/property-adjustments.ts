...
export function propertyAdjustments(subject:ComparisonProperty,comparable:ComparisonProperty,taxYear=2026) {
  ...
  const lines:AdjustmentLine[]=[
    ...
    {factor:"Additional improvements",amount:calculation.amounts["Additional improvements"],explanation:"Your additional improvements’ reported values minus the comparable’s. The Appraisal District groups each additional structure with its attached features, such as garages, porches and pools. These values already include neighborhood multipliers and are counted once here. $0 means no additional value is recorded in this release.",inputs:[input("Your secondary improvements",si.secondary),input("Comparable secondary improvements",ci.secondary),
