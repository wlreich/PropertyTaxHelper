...
export async function getPropertyActivity(id:string,year:number|null=null){
 ...
 return parseActivity(await rpc('property_neighborhood_activity',{p_id:id,p_year:year},{SUPABASE_URL:process.env.SUPABASE_URL,SUPABASE_PUBLISHABLE_KEY:process.env.SUPABASE_PUBLISHABLE_KEY},fetch));
}
