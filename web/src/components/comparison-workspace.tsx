...
function ComparisonWorkspaceContent({data,initialIds,initialView="reported",initialStep="select",evidence,focusTarget,evidenceQuery="",inspection,setInspection}:WorkspaceProps & {inspection:ComparisonInspection|null;setInspection:(value:ComparisonInspection|null)=>void}) {
  ...
  return <>
    ...
    <details className="comparison-card comparison-method"><summary id="comparison-rules-heading">How matching works</summary><p>ParcelSavvy starts with the Appraisal District’s 2026 Sale and Equity Grids methodology. Suggestions require the same recorded market area and construction class, then use progressively wider living-area and age ranges.</p>
      ...
      <p><strong>Limits of the match:</strong> ParcelSavvy can verify the recorded market area, construction class, living area, and age shown on this page, but not condition or every eligibility factor in the Appraisal District’s method. Homes with multiple living-area buildings are omitted when the primary improvement cannot be established. Suggestions are ordered by tier, size difference, age difference, and property ID; they are not the Appraisal District’s confirmed comparable list.</p>
