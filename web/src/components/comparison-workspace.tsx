  ...
  return <>
    ...
    <div className="comparison-workspace">
      <section className="comparison-card comparison-suggestions" aria-labelledby="suggestions-heading">
        ...
        <p className="comparison-inline-note">Suggestions favor similar recorded characteristics. They are not the Appraisal District’s confirmed comparable list.</p>
