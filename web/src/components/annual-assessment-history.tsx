...
export function AnnualAssessmentHistory() {
  ...
  return <section className="overview-section property-section annual-history" aria-labelledby="history-heading">
    ...
    {unavailable ? <p>Assessment history is temporarily unavailable. Try again in a few minutes.</p> : !rows.length ?
      ...
      <p className="overview-note">Change compares proposed with certified market value; it is not tax savings. “Reduction only” means a value reduction is observed without a recorded protest. A missing entry does not rule out a protest.</p>
