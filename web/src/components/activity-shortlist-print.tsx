...
export function ActivityShortlistPrint({data,window,query}:{data:WindowActivity|null;window:EvidenceWindow;query:EvidenceQuery}){
 const selected=activitySelection(query.activitySelected),type=typeof query.activityType==='string'&&query.activityType in activityTypes?query.activityType as ActivityFilter:'all';
 const sort=typeof query.activitySort==='string'?query.activitySort:'newest';
