...
1. Review and apply the committed `tcad_ingestion_foundation` migration. Ensure migration versions in Git and Supabase agree before using CLI migration push. PR #7 separately reconciles the earlier database-health migration.
